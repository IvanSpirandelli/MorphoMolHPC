...
function rwm_with_persistence_call(
    ...
    energy(x) = solvation_free_energy_with_persistence_in_bounds_without_diagrams(x, template_centers, radii, rs, pf, 0.0, overlap_slope, persistence_weights, bnds, delaunay_eps)
